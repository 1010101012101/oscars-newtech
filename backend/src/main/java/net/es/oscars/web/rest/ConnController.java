...
import net.es.oscars.web.dto.ConnChangeResult;
import net.es.oscars.web.dto.ConnException;
import net.es.oscars.web.dto.ConnectionFilter;
import net.es.oscars.web.dto.ConnectionList;
